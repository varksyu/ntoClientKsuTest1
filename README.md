...
Отметим, что работу необходимо осуществлять в представленных проектах-заготовках (шаблонах). Шаблон для клиентской части можно найти [по ссылке](https://git.sicampus.ru/Olympic/NTO-2024-Client).
